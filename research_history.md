...
## Iteration 29 — 2026-06-06T20:17:07
Branch: `experiment/29_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 43080ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)

---

## Iteration 30 — 2026-06-06T20:36:08
Branch: `experiment/30_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 43051ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)

---

## Iteration 31 — 2026-06-06T20:55:10
Branch: `experiment/31_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 42995ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)
...
## Iteration 33 — 2026-06-06T21:35:15
Branch: `experiment/33_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 43144ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)

---

## Iteration 34 — 2026-06-06T21:54:47
Branch: `experiment/34_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 43099ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)

---

## Iteration 35 — 2026-06-06T22:14:19
Branch: `experiment/35_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 43194ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)

---

## Iteration 36 — 2026-06-06T22:33:39
Branch: `experiment/36_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 43177ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)

---

## Iteration 37 — 2026-06-06T22:53:09
Branch: `experiment/37_ils-perturbation`
Proposal: Add an iterated local search loop around the existing local search to escape local optima by randomly relocating a small number of customers between routes.
Result: 40v / 9870.11 / 43306ms / gap 15.81%
Decision: DISCARDED (quality_improved=False, time_improved=False)
